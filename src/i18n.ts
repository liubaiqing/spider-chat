...
const zh: TranslationDictionary = {
  ...
  delete: "删除",
  cancel: "取消",
  newMapCommand: "新建 Spider Chat 图谱",
  switchMapCommand: "切换 Spider Chat 图谱",
  defaultMapTitle: "未命名对话图谱",
  rootQuestionTitle: "根问题",
  untitledQuestionTitle: "未命名问题",
  loading: "正在加载 Spider Chat...",
  newChild: "创建分支",
  mapNameLabel: "图谱",
  ...
  mapSwitcherPlaceholder: "切换 Spider Chat 图谱...",
  ...
  openSettings: "打开 Spider Chat 设置",
  openSettingsFailed: "无法自动打开设置，请前往“设置 → Spider Chat”。",
  ...
  scrollLatest: "跳到最新消息",
  details: "详情",
  onboardingCardLabel: "Spider Chat 引导卡片",
  onboardingAskTitle: "从一个问题开始",
  onboardingAskBody: "先问一个根问题。Spider Chat 会把这次探索固定成图谱里的起点。",
  ...
  onboardingDoneTitle: "很棒哦，做得好，欢迎来到 Spider Chat",
  ...
  settingsTitle: "Spider Chat",
  settingLanguageName: "界面语言",
  settingLanguageDesc: "切换插件界面语言，所有已打开的 Spider Chat 视图会立即刷新。",
  ...
  settingOnboardingDesc: "重新显示右侧面板里的 Spider Chat 核心操作提示。",
...
const en: TranslationDictionary = {
  ...
  mapSwitcherPlaceholder: "Switch Spider Chat map...",
  ...
  openSettings: "Open Spider Chat settings",
  openSettingsFailed: "Could not open settings automatically. Go to Settings → Spider Chat.",
  ...
  details: "Details",
  onboardingCardLabel: "Spider Chat guide card",
  onboardingAskTitle: "Start with one question",
  onboardingAskBody: "Ask a root question first. Spider Chat anchors this exploration as the starting point of the map.",
  ...
  onboardingDoneTitle: "Nice work. Welcome to Spider Chat",
  ...
  settingLanguageDesc: "Switch the plugin interface language. All open Spider Chat views update immediately.",
  ...
  settingOnboardingDesc: "Show the Spider Chat core workflow hints in the right panel again.",
